...
/*
 * Nível AVENTUREIRO — Mantém o cadastro de 2 cartas (sem laços/condicionais)
 * e adiciona propriedades calculadas:
 *   - Densidade Populacional = População / Área
 *   - PIB per Capita = PIB / População
 * As novas propriedades também são exibidas.
 */

// Estrutura com atributos básicos + calculados
typedef struct {
    char codigo[4];
...
int main(void) {
    ...
    // Cálculos (assume entradas válidas; não há validação pois não podemos usar if)
